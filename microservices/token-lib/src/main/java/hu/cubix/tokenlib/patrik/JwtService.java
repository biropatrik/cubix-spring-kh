package hu.cubix.tokenlib.patrik;
...
public class JwtService {
    ...
    openssl ec -in ec-p512-private.pem -pubout -out public.pem
     */
    @Value("${hu.cubix.tokenlib.keypaths.private:#{null}}")
    private String pathToPemWithPrivateKey;
    @Value("${hu.cubix.tokenlib.keypaths.public:#{null}}")
